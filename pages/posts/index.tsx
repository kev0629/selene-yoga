      ...
      <main className='text-xs md:text-base font-main'>
        ...
        <div  className="relative h-32">
          ...
          <div className='absolute inset-0 flex flex-col justify-center center-content items-center z-10'>
            <div>
              <div className='text-center text-selene-green-dark bold text-4xl font-serif'>Articles</div>
            </div>
          </div>
        </div>
        ...
        <div className={clsx("grid grid-cols-1 gap-1 m-10 justify-items-center justify-content-center ",
