    ...
    val1: (
      <div className="flex justify-around">
        ...
        <div className="w-32 text-center">
          <div>Ateliers</div> <div>Séminaires</div> <div>Stages</div>
        </div>
      </div>
    ),
  },
...
const PricesTable = (props: PropsTable) => {
  ...
  return (
    <div className="flex items-center content-center justify-center">
      <div
        className="bg-white flex items-center content-center justify-center rounded-md w-full md:w-96 lg:w-[32rem]
    "
      >
  ...
  return (
    <div className="flex flex-col content-center items-center justify-center space-y-4 md:flex-none md:grid md:grid-cols-2">
      ...
      <div className="text-white text-xs">
        Pour toute souscription d’une offre à domicile, proposition de contrat
        CESU.
        <br />
        Impossible de payer, demandez quand même ! Entre 3 et 5 consultations
        par mois sont à prix libres ou bénévoles.
      </div>
    </div>
  );
};
