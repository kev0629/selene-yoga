    ...
    <>
      <div className="flex justify-center flex-col h-max md:h-[32rem] lg:h-[51rem]">
        <div className="flex justify-center mt-10">
          <div
            className={clsx(
              "relative text-black bg-gradient-to-b  via-[#C0CCCE]/75 from-[#C0CCCE]/75 border pb-10 py-2 px-6 rounded-xl text-center",
              " md:px-12",
              "lg:px-24 "
            )}
          >
        ...
        <div className="flex justify-center m-10">
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="rounded-md p-1 text-white text-base border-[1px] bg-gradient-to-b mt-10 from-[#C0CCCE] border-white"
            onClick={() => props.setHandleStory(!props.handleStory)}
          >
