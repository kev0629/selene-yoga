    ...
    <div className="h-96 lg:h-[40rem] flex flex-col justify-between space">
      <div>
        <div className="m-5 text-3xl text-center font-serif text-selene-green lg:text-5xl">
          Séléné Yoga vous invite à votre seule réelle liberté, celle
          d’embrasser votre destin.
        </div>
        <div className="m-5 flex justify-center">
          <Link href="/Oeuvre">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className=" bg-white border rounded-lg border-selene-blue p-1 text-selene-green text-base px-11"
            >
              Ce qui oeuvre ici
            </motion.button>
          </Link>
